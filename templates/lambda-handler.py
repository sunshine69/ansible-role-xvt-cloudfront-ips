...
This was taken from: https://aws.amazon.com/blogs/security/how-to-automatically-update-your-security-groups-for-amazon-cloudfront-and-aws-waf-by-using-aws-lambda/
'''
...
SECURITY_GROUP_TAG_FOR_HTTP = { 'Name': 'xvt-{{ vpc_name }}-sg-cloudfront-http', 'AutoUpdate': 'true', 'Protocol': 'http' }
SECURITY_GROUP_TAG_FOR_HTTPS = { 'Name': 'xvt-{{ vpc_name }}-sg-cloudfront-https', 'AutoUpdate': 'true', 'Protocol': 'https' }
